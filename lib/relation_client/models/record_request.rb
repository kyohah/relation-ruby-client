...
module RelationClient
  class RecordRequest
    ...
    # 顧客電話番号
    attr_accessor :customer_tel

    # 対応種別
    attr_accessor :icon_cd
    ...
    # @param [Object] status_cd Object to be assigned
    def status_cd=(status_cd)
      validator = EnumAttributeValidator.new('String', ["open", "ongoing", "closed", "unwanted", "trash", "spam", "deleted"])
      unless validator.valid?(status_cd)
        fail ArgumentError, "invalid value for \"status_cd\", must be one of #{validator.allowable_values}."
      end
      @status_cd = status_cd
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] icon_cd Object to be assigned
    def icon_cd=(icon_cd)
      validator = EnumAttributeValidator.new('String', ["received_phone", "called_phone", "meeting", "sales", "postal", "note"])
      unless validator.valid?(icon_cd)
        fail ArgumentError, "invalid value for \"icon_cd\", must be one of #{validator.allowable_values}."
      end
      @icon_cd = icon_cd
    end
